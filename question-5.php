    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="card shadow mb-4" style="margin-left: 15px;margin-right: 15px;margin-top: 20px;">
                ...
                <br><br>
                <b>Note:</b> if there is no file available Please wait for some minutes and try again.
                <br><br>
                You can search on the Internet for Linux commands.
                Example:
                <ul>
                <li>how to delete files and folders in Linux.</li>
                <li>How to delete all files and folders in linux.</li>
                </ul>
                </div>
            </div>
            ...
            <div class="card card-sm card-body rounded mb-3" style="margin-right: 15px;margin-left: 15px;padding: 10px;background-color: #9936f3;"> 
              ...
              <div class="container" style="margin-top: 25px;">
                <div class="row">
                  <div class="col-sm">
                    <button type="button" class="btn btn-primary custom"><a href="question-4.php" style="color: #fff; text-decoration: none;"><b>Previous</b></a></button>
                  </div>
                  <div class="col-sm">

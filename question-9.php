        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="card shadow mb-4" style="margin-left: 15px;margin-right: 15px;margin-top: 20px;">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold" style="color: #fff;">Question 9</h6>
                </div>
                ...
                <br><br>
                <b>Note:</b>You have to make a temporary folder in /tmp/demo and copy demo.zip file there to decompress it.
                <br><br>
                You can search on the Internet for Linux commands.
                Example:
                <ul>
                <li>how to decompress file in Linux.</li>
                <li>how to unzip file in Linux.</li>
                </ul>
                </div>
            </div>
            ...
            <div class="card card-sm card-body rounded mb-3" style="margin-right: 15px;margin-left: 15px;padding: 10px;background-color: #9936f3;"> 
						...
						<div class="collapse" id="panel-1">
							<div class="pt-3">
								<p class="mb-0" style="color: #fff;">
                                    <ul>
                                    <li>cd Question-9</li>
                                    <li>mkdir /home/labuser/tmp/demo</li>
                                    <li>cp demo.zip /home/labuser/tmp/demo.zip</li>
                                    <li>cd /home/labuser/tmp/demo</li>
                                    <li>unzip demo.zip</li>
                                    <li>cat solved.txt</li>
                                    </ul>
                                </p>
							</div>
						</div>
              ...
              <div class="container" style="margin-top: 25px;">
                <div class="row">
                  <div class="col-sm">
                    <button type="button" class="btn btn-primary custom"><a href="question-8.php" style="color: #fff; text-decoration: none;"><b>Previous</b></a></button>
                  </div>
                  <div class="col-sm">
                    <button type="button" class="btn btn-primary custom" style="margin-left: 165px;"><a href="question-10.php" style="color: #fff; text-decoration: none;"><b>Next</b></a></button>
                  </div>
                </div>
              </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-color: #000;">
            ...
            <div id="content">
                ...
                <div class="sidebar-heading" style="font-size: 35px;color: #fff;">
                            <b style="margin-left: 200px;">Basic Linux Commands Lab</b>
                </div>
                ...
                <html> 
<iframe width="80%" height="80%" src="terminal.php" frameborder="yes" scrolling="yes" name="myIframe" id="myIframe" style="margin-left: 90px;"> </iframe>
